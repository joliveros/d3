!function() {
  ...
  d3.behavior.zoom = function() {
    var view = {
      ...
      y: 0,
      k: 1
    }, center, center0, duration = 250, event = d3_eventDispatch(zoom, "zoomstart", "zoom", "zoomend"), mousedown = "mousedown.zoom", mousemove = "mousemove.zoom", mouseup = "mouseup.zoom", mousewheelTimer, scale, scaleExtent = d3_behavior_zoomInfinity, size = [ 960, 500 ], touchstart = "touchstart.zoom", touchtime, translate0, x0, x1, xExtent = d3_behavior_scaleInfinity, y0, y1, yExtent = d3_behavior_scaleInfinity, zooming = 0;
  ...
  var d3_behavior_zoomInfinity = [ 0, Infinity ], d3_behavior_zoomDelta, d3_behavior_scaleInfinity = [ -Infinity, Infinity ], d3_behavior_zoomWheel;
  d3.color = d3_color;
  function d3_color() {}
